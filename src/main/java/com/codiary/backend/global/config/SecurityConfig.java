        ...
        return http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers("/members/login").permitAll()
                                // Post 관련 접근
                                //.requestMatchers("/posts","/posts/{postId}", "/posts/visibility/{postId}", "/posts/team/{postId}", "/posts/coauthors/{postId}", "/posts/categories/{postId}", "/posts/team/{teamId}/member/{memberId}/paging", "/posts/project/{projectId}/team/{teamId}/paging", "/posts/project/{projectId}/member/{memberId}/paging", "/posts/member/{memberId}/paging").permitAll() //.hasRole("USER")
