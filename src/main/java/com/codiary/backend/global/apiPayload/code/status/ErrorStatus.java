...
public enum ErrorStatus implements BaseErrorCode {
    ...
    TEAM_ADMIN_NOT_FOUND(HttpStatus.BAD_REQUEST, "TEAM_2006", "팀 관리자를 찾을 수 없습니다"),
...
//    BOOKMARK_DELETE_UNAUTHORIZED(HttpStatus.BAD_REQUEST, "BOOKMARK_6004", "북마크 삭제 권한이 없습니다."),
    ...
    BOOKMARK_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "BOOKMARK_6006", "이미 북마크한 포스트입니다."),
    BOOKMARK_ALREADY_CANCELED(HttpStatus.BAD_REQUEST, "BOOKMARK_6007", "이미 북마크 상태가 아닌 포스트입니다."),
