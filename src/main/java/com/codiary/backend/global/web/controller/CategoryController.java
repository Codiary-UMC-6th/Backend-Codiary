...
public class CategoryController {
    ...
    @GetMapping("/list")
    @Operation(summary = "키워드 입력을 통해 관련 카테고리 리스트 조회 API", description = "키워드 입력을 통해 관련 카테고리 리스트 조회합니다. 입력한 키워드가 포함된 모든 카테고리를 리스트로 조회할 수 있습니다. Param으로 키워드를 입력하세요.", security = @SecurityRequirement(name = "accessToken"))
